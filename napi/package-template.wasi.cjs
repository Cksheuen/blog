...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  try {
    __wasmFilePath = __nodePath.resolve('@napi-rs/napi-test-wasm32-wasi')
  } catch {
    throw new Error('Cannot find package-template.wasm32-wasi.wasm file, and @napi-rs/napi-test-wasm32-wasi package is not installed.')
  }
}
